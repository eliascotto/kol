...
var G__76137 = o;
reagent.impl.template.goog$module$goog$object.set(G__76137,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__76499__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__76499 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__76500__i = 0, G__76500__a = new Array(arguments.length -  0);
while (G__76500__i < G__76500__a.length) {G__76500__a[G__76500__i] = arguments[G__76500__i + 0]; ++G__76500__i;}
  args = new cljs.core.IndexedSeq(G__76500__a,0,null);
} 
return G__76499__delegate.call(this,args);};
G__76499.cljs$lang$maxFixedArity = 0;
G__76499.cljs$lang$applyTo = (function (arglist__76501){
var args = cljs.core.seq(arglist__76501);
return G__76499__delegate(args);
});
G__76499.cljs$core$IFn$_invoke$arity$variadic = G__76499__delegate;
return G__76499;
})()
;
} else {
...
var G__76147 = o;
reagent.impl.template.goog$module$goog$object.set(G__76147,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__76519__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__76519 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__76521__i < G__76521__a.length) {G__76521__a[G__76521__i] = arguments[G__76521__i + 0]; ++G__76521__i;}
  args = new cljs.core.IndexedSeq(G__76521__a,0,null);
} 
return G__76519__delegate.call(this,args);};
G__76519.cljs$lang$maxFixedArity = 0;
G__76519.cljs$lang$applyTo = (function (arglist__76523){
var args = cljs.core.seq(arglist__76523);
return G__76519__delegate(args);
});
G__76519.cljs$core$IFn$_invoke$arity$variadic = G__76519__delegate;
return G__76519;
})()
;
} else {
...
var G__76163 = props;
var G__76163__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76163,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__76163);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76163__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__76189 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76189,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__76189;
}
})(),id_class);
...
var G__76196 = (cljs.core.count(argv) - first_child);
switch (G__76196) {
case (0):
...
var vec__76223 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76223,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76223,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76223,(2),null);
...
var temp__5757__auto___76557 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___76557 == null)){
} else {
var key_76558 = temp__5757__auto___76557;
(jsprops.key = key_76558);
}
...
var temp__5757__auto___76561 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___76561 == null)){
} else {
var key_76564 = temp__5757__auto___76561;
(jsprops.key = key_76564);
}
...
var temp__5757__auto___76571 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___76571 == null)){
} else {
var key_76576 = temp__5757__auto___76571;
(jsprops.key = key_76576);
}
...
var temp__5757__auto___76586 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___76586 == null)){
} else {
var key_76587 = temp__5757__auto___76586;
(jsprops.key = key_76587);
}
...
var temp__5757__auto___76596 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___76596 == null)){
} else {
var key_76598 = temp__5757__auto___76596;
(jsprops.key = key_76598);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__76282_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__76282_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__76323 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76323,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76323,(1),null);
...
break;
default:
var G__76606 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__76607 = compiler;
v = G__76606;
compiler = G__76607;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template76425 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template76425 = (function (opts,id,fn_to_element,parse_fn,meta76426){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta76426 = meta76426;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template76425.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_76427,meta76426__$1){
var self__ = this;
var _76427__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template76425(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta76426__$1));
}));

(reagent.impl.template.t_reagent$impl$template76425.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_76427){
var self__ = this;
var _76427__$1 = this;
return self__.meta76426;
}));

(reagent.impl.template.t_reagent$impl$template76425.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template76425.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template76425.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template76425.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template76425.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template76425.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta76426","meta76426",-761101510,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template76425.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template76425.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template76425");

(reagent.impl.template.t_reagent$impl$template76425.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template76425");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template76425.
 */
reagent.impl.template.__GT_t_reagent$impl$template76425 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template76425(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta76426){
return (new reagent.impl.template.t_reagent$impl$template76425(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta76426));
});

}

return (new reagent.impl.template.t_reagent$impl$template76425(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
