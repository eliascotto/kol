...
var G__83131 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(choices,new_index);
return (id_fn.cljs$core$IFn$_invoke$arity$1 ? id_fn.cljs$core$IFn$_invoke$arity$1(G__83131) : id_fn.call(null,G__83131));
} else {
return null;
}
});
...
var group_headers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__83138_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"group","group",582596132)],[cljs.core.gensym.cljs$core$IFn$_invoke$arity$0(),p1__83138_SHARP_]);
...
var G__83190_83334 = event.target.value;
(set_filter_text.cljs$core$IFn$_invoke$arity$1 ? set_filter_text.cljs$core$IFn$_invoke$arity$1(G__83190_83334) : set_filter_text.call(null,G__83190_83334));
 ...
 */
re_com.dropdown.filter_text_box = cljs.core.with_meta(re_com.dropdown.filter_text_box_base,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (p1__83197_SHARP_){
var node = reagent.dom.dom_node(p1__83197_SHARP_).firstChild;
return node.focus();
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (p1__83198_SHARP_){
var node = reagent.dom.dom_node(p1__83198_SHARP_).firstChild;
return node.focus();
})], null));
/**
...
var text = (cljs.core.truth_(cljs.core.deref(internal_model))?(function (){var G__83202 = re_com.util.item_for_id.cljs$core$IFn$_invoke$arity$variadic(cljs.core.deref(internal_model),choices,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"id-fn","id-fn",316222798),id_fn], 0));
return (label_fn.cljs$core$IFn$_invoke$arity$1 ? label_fn.cljs$core$IFn$_invoke$arity$1(G__83202) : label_fn.call(null,G__83202));
})():placeholder);
...
var callback = (function (p__83213){
var map__83214 = p__83213;
var map__83214__$1 = cljs.core.__destructure_map(map__83214);
var args = map__83214__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83214__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83214__$1,new cljs.core.Keyword(null,"error","error",-978969032));
...
var G__83216 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"filter-text","filter-text",-381699202),text,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668),regex_filter_QMARK_], null);
var G__83217 = (function (p1__83207_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"result","result",1415092211),p1__83207_SHARP_], null));
});
var G__83218 = (function (p1__83208_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),p1__83208_SHARP_], null));
});
return (choices.cljs$core$IFn$_invoke$arity$3 ? choices.cljs$core$IFn$_invoke$arity$3(G__83216,G__83217,G__83218) : choices.call(null,G__83216,G__83217,G__83218));
});
/**
...
var temp__5753__auto___83355 = new cljs.core.Keyword(null,"timer","timer",-1266967739).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state));
if(cljs.core.truth_(temp__5753__auto___83355)){
var timer_83356 = temp__5753__auto___83355;
clearTimeout(timer_83356);
} else {
}
...
var len__4864__auto___83393 = arguments.length;
var i__4865__auto___83395 = (0);
while(true){
if((i__4865__auto___83395 < len__4864__auto___83393)){
args__4870__auto__.push((arguments[i__4865__auto___83395]));

var G__83402 = (i__4865__auto___83395 + (1));
i__4865__auto___83395 = G__83402;
continue;
} else {
}
break;
...
(re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic = (function (p__83241){
var map__83242 = p__83241;
var map__83242__$1 = cljs.core.__destructure_map(map__83242);
var args = map__83242__$1;
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83242__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83242__$1,new cljs.core.Keyword(null,"model","model",331153215));
var regex_filter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83242__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
var debounce_delay = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__83242__$1,new cljs.core.Keyword(null,"debounce-delay","debounce-delay",-608187982),(250));
...
var set_filter_text = (function (text,p__83244,debounce_QMARK_){
var map__83245 = p__83244;
var map__83245__$1 = cljs.core.__destructure_map(map__83245);
var args__$1 = map__83245__$1;
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83245__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
...
return (function() { 
var G__83421__delegate = function (p__83247){
var map__83249 = p__83247;
var map__83249__$1 = cljs.core.__destructure_map(map__83249);
var args__$1 = map__83249__$1;
var group_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__83249__$1,new cljs.core.Keyword(null,"group-fn","group-fn",129203707),new cljs.core.Keyword(null,"group","group",582596132));
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var model__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"model","model",331153215));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__83249__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263),new cljs.core.Keyword(null,"label","label",1718410804));
var tab_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"tab-index","tab-index",895755393));
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var title_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"title?","title?",-1510254555));
var render_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__83249__$1,new cljs.core.Keyword(null,"render-fn","render-fn",398796518),label_fn);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
var choices__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__83249__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798),new cljs.core.Keyword(null,"id","id",-1388402092));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var debounce_delay__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"debounce-delay","debounce-delay",-608187982));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var filter_box_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83249__$1,new cljs.core.Keyword(null,"filter-box?","filter-box?",-1157583688));
...
var callback = (function (p1__83230_SHARP_){
cljs.core.reset_BANG_(internal_model,p1__83230_SHARP_);
...
var G__83260_83449 = cljs.core.deref(internal_model);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__83260_83449) : on_change.call(null,G__83260_83449));
} else {
}
...
var G__83270_83478 = cljs.core.deref(internal_model);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__83270_83478) : on_change.call(null,G__83270_83478));
} else {
}
...
var key_handler = (function (p1__83233_SHARP_){
if(cljs.core.truth_(disabled_QMARK___$1)){
return false;
} else {
var G__83273 = p1__83233_SHARP_.which;
switch (G__83273) {
case (13):
return press_enter();
...
})())?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li.loading","li.loading",1659621189),"Loading..."], null):(cljs.core.truth_((function (){var and__4251__auto__ = choices_fn_QMARK_;
if(and__4251__auto__){
return new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state));
} else {
return and__4251__auto__;
}
})())?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li.error","li.error",534172652),new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state))], null):(((cljs.core.count(filtered_choices) > (0)))?(function (){var vec__83277 = re_com.dropdown.choices_with_group_headings(filtered_choices,group_fn);
var group_names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83277,(0),null);
var group_opt_lists = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__83277,(1),null);
...
var make_choices = (function (p1__83235_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(make_a_choice,p1__83235_SHARP_);
});
...
var G__83421 = function (var_args){
var p__83247 = null;
if (arguments.length > 0) {
var G__83520__i = 0, G__83520__a = new Array(arguments.length -  0);
while (G__83520__i < G__83520__a.length) {G__83520__a[G__83520__i] = arguments[G__83520__i + 0]; ++G__83520__i;}
  p__83247 = new cljs.core.IndexedSeq(G__83520__a,0,null);
} 
return G__83421__delegate.call(this,p__83247);};
G__83421.cljs$lang$maxFixedArity = 0;
G__83421.cljs$lang$applyTo = (function (arglist__83521){
var p__83247 = cljs.core.seq(arglist__83521);
return G__83421__delegate(p__83247);
});
G__83421.cljs$core$IFn$_invoke$arity$variadic = G__83421__delegate;
return G__83421;
})()
;
}));
...
/** @this {Function} */
(re_com.dropdown.single_dropdown.cljs$lang$applyTo = (function (seq83236){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq83236));
}));
