...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__81968 = c;
var G__81968__$1 = (((G__81968 == null))?null:G__81968.prototype);
if((G__81968__$1 == null)){
return null;
} else {
return G__81968__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__81973 = c;
var G__81973__$1 = (((G__81973 == null))?null:G__81973.prototype);
if((G__81973__$1 == null)){
return null;
} else {
return G__81973__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__82098__delegate = function (args){
...
var G__82098 = function (var_args){
var args = null;
...
while (G__82099__i < G__82099__a.length) {G__82099__a[G__82099__i] = arguments[G__82099__i + 0]; ++G__82099__i;}
  args = new cljs.core.IndexedSeq(G__82099__a,0,null);
} 
return G__82098__delegate.call(this,args);};
G__82098.cljs$lang$maxFixedArity = 0;
G__82098.cljs$lang$applyTo = (function (arglist__82100){
var args = cljs.core.seq(arglist__82100);
return G__82098__delegate(args);
});
G__82098.cljs$core$IFn$_invoke$arity$variadic = G__82098__delegate;
return G__82098;
})()
;})(c,compiler,f,_,res))
:res);
...
var or__4253__auto__ = (function (){var G__81983 = c;
var G__81983__$1 = (((G__81983 == null))?null:G__81983.constructor);
if((G__81983__$1 == null)){
return null;
} else {
return G__81983__$1.displayName;
}
})();
...
var G__81984 = c;
var G__81984__$1 = (((G__81984 == null))?null:G__81984.constructor);
if((G__81984__$1 == null)){
return null;
} else {
return G__81984__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__81985 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__81986 = c;
(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__81986);
...
}finally {(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__81985);
}});
...
var G__81987 = key;
var G__81987__$1 = (((G__81987 instanceof cljs.core.Keyword))?G__81987.fqn:null);
switch (G__81987__$1) {
...
var or__4253__auto__ = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.util._STAR_always_update_STAR_;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var c = this;
...
var c = this;
var G__82004_82112 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__82004_82112 == null)){
} else {
re_frisk.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__82004_82112);
}
...
var renders_82113 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_82114 = cljs.core.first(cljs.core.vals(renders_82113));
...
if((cljs.core.count(renders_82113) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_82113))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_82114)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_82114], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var or__4253__auto____$1 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.util.fun_name(render_fun);
...
var G__82067 = o;
re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.set(G__82067,cljs.core.name(k),v);
...
var temp__5755__auto__ = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.cached_react_class(compiler,tag);
if((temp__5755__auto__ == null)){
...
while (G__82134__i < G__82134__a.length) {G__82134__a[G__82134__i] = arguments[G__82134__i + 0]; ++G__82134__i;}
  args = new cljs.core.IndexedSeq(G__82134__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__82082 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__82083 = c;
(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__82083);
...
}finally {(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__82082);
}});
...
var vec__82088 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82088,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82088,(1),null);
...
var G__82091 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__82091 == null)){
return null;
} else {
return re_frisk.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__82091);
}
});
}),[]);
...
var and__4251__auto__ = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.util._STAR_always_update_STAR_ === false;
if(and__4251__auto__){
try{return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(old_argv,new_argv);
}catch (e82092){var e = e82092;
if(re_frisk.inlined_deps.reagent.v1v0v0.reagent.debug.has_console){
((re_frisk.inlined_deps.reagent.v1v0v0.reagent.debug.tracking)?re_frisk.inlined_deps.reagent.v1v0v0.reagent.debug.track_console:console).warn(["Warning: ","Exception thrown while comparing argv's in shouldComponentUpdate: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(old_argv)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new_argv)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(e)].join(''));
} else {
}
...
var or__4253__auto__ = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.cached_react_class(compiler,tag);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
