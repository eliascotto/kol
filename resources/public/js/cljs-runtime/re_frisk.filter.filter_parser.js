...
var G__87290 = cljs.tools.reader.reader_types.peek_char(rdr);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__87290)){
...
var vec__87292 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(s,/\s+/,(2));
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__87292,(0),null);
var rest = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__87292,(1),null);
...
try{var map__87323 = re_frisk.filter.filter_parser.read_string_SINGLEQUOTE_(s);
var map__87323__$1 = cljs.core.__destructure_map(map__87323);
var foo = map__87323__$1;
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__87323__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__87323__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
...
try{var map__87382 = re_frisk.filter.filter_parser.read_string_SINGLEQUOTE_(s);
var map__87382__$1 = cljs.core.__destructure_map(map__87382);
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__87382__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__87382__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"val","val",128701612),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"expr","expr",745722291),val], null),new cljs.core.Keyword(null,"rest","rest",-1241696419),rest], null);
}catch (e87341){var _ = e87341;
var vec__87355 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(s,/\s+/,(2));
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__87355,(0),null);
var rest = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__87355,(1),null);
...
var G__87385 = cljs.core.first(s);
switch (G__87385) {
case "[":
case "(":
case "{":
...
var map__87388 = re_frisk.filter.filter_parser.parse_part(s__$2);
var map__87388__$1 = cljs.core.__destructure_map(map__87388);
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__87388__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__87388__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
