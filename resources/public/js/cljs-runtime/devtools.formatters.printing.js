...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq65088){
var G__65089 = cljs.core.first(seq65088);
var seq65088__$1 = cljs.core.next(seq65088);
var G__65090 = cljs.core.first(seq65088__$1);
var seq65088__$2 = cljs.core.next(seq65088__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65089,G__65090,seq65088__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__65107_SHARP_){
return (!((cljs.core.meta(p1__65107_SHARP_) == null)));
})))){
...
var map__65118 = opts;
var map__65118__$1 = cljs.core.__destructure_map(map__65118);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65118__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e65119){var _e__64417__auto__ = e65119;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e65121){var _e__64417__auto__ = e65121;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__65136 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__65137 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__65137);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65142__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__65136);
}});
...
var temp__5751__auto___65184 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___65184)){
var managed_print_level_65185 = temp__5751__auto___65184;
var _STAR_print_level_STAR__orig_val__65153_65186 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__65154_65187 = managed_print_level_65185;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__65154_65187);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__65146_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__65146_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__65153_65186);
}} else {
job_fn();
}
