...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_77451 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_77451(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_77458 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_77458(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_77462 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_77462(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_77465 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_77465(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_77468 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_77468(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_77469 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_77469(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_77474 = (function (this$,header){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_77474(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_77479 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_77479(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_77488 = (function (this$,request){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_77488(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_77497 = (function (this$,response){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_77497(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k77320,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__77333 = k77320;
var G__77333__$1 = (((G__77333 instanceof cljs.core.Keyword))?G__77333.fqn:null);
switch (G__77333__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k77320,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__77341){
var vec__77352 = p__77341;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77352,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77352,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__77319){
var self__ = this;
var G__77319__$1 = this;
return (new cljs.core.RecordIter((0),G__77319__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this77324,other77325){
var self__ = this;
var this77324__$1 = this;
return (((!((other77325 == null)))) && ((((this77324__$1.constructor === other77325.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77324__$1.status,other77325.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77324__$1.body,other77325.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77324__$1.status_text,other77325.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77324__$1.headers,other77325.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77324__$1.was_aborted,other77325.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77324__$1.__extmap,other77325.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k77320){
var self__ = this;
var this__4509__auto____$1 = this;
var G__77396 = k77320;
var G__77396__$1 = (((G__77396 instanceof cljs.core.Keyword))?G__77396.fqn:null);
switch (G__77396__$1) {
case "status":
case "body":
case "status-text":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k77320);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__77319){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__77418 = cljs.core.keyword_identical_QMARK_;
var expr__77419 = k__4511__auto__;
if(cljs.core.truth_((pred__77418.cljs$core$IFn$_invoke$arity$2 ? pred__77418.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__77419) : pred__77418.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__77419)))){
return (new ajax.protocols.Response(G__77319,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__77418.cljs$core$IFn$_invoke$arity$2 ? pred__77418.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__77419) : pred__77418.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__77419)))){
return (new ajax.protocols.Response(self__.status,G__77319,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__77418.cljs$core$IFn$_invoke$arity$2 ? pred__77418.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__77419) : pred__77418.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__77419)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__77319,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__77418.cljs$core$IFn$_invoke$arity$2 ? pred__77418.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__77419) : pred__77418.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__77419)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__77319,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__77418.cljs$core$IFn$_invoke$arity$2 ? pred__77418.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__77419) : pred__77418.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__77419)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__77319,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__77319),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__77319){
var self__ = this;
var this__4501__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__77319,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__77327){
var extmap__4542__auto__ = (function (){var G__77438 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__77327,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__77327)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__77438);
} else {
return G__77438;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__77327),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__77327),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__77327),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__77327),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__77327),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
