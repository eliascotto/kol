...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__80609_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__80609_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__80610_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__80610_SHARP_)));
}),row));
});
...
var G__80613 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__80614 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__80613,G__80614) : expound.printer.format.call(null,G__80613,G__80614));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__80616_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__80616_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__80617_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__80617_SHARP_)).length),"="));
}),header);
...
var iter__4652__auto__ = (function expound$printer$multirow_$_iter__80623(s__80624){
return (new cljs.core.LazySeq(null,(function (){
var s__80624__$1 = s__80624;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__80624__$1);
if(temp__5753__auto__){
var s__80624__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__80624__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__80624__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__80626 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__80625 = (0);
while(true){
if((i__80625 < size__4651__auto__)){
var row_idx = cljs.core._nth(c__4650__auto__,i__80625);
cljs.core.chunk_append(b__80626,(function (){var iter__4652__auto__ = ((function (i__80625,row_idx,c__4650__auto__,size__4651__auto__,b__80626,s__80624__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__80623_$_iter__80643(s__80644){
return (new cljs.core.LazySeq(null,((function (i__80625,row_idx,c__4650__auto__,size__4651__auto__,b__80626,s__80624__$2,temp__5753__auto__,split_row_contents){
return (function (){
var s__80644__$1 = s__80644;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__80644__$1);
if(temp__5753__auto____$1){
var s__80644__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__80644__$2)){
var c__4650__auto____$1 = cljs.core.chunk_first(s__80644__$2);
var size__4651__auto____$1 = cljs.core.count(c__4650__auto____$1);
var b__80646 = cljs.core.chunk_buffer(size__4651__auto____$1);
if((function (){var i__80645 = (0);
while(true){
if((i__80645 < size__4651__auto____$1)){
var col_idx = cljs.core._nth(c__4650__auto____$1,i__80645);
cljs.core.chunk_append(b__80646,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__80868 = (i__80645 + (1));
i__80645 = G__80868;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__80646),expound$printer$multirow_$_iter__80623_$_iter__80643(cljs.core.chunk_rest(s__80644__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__80646),null);
}
} else {
var col_idx = cljs.core.first(s__80644__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__80623_$_iter__80643(cljs.core.rest(s__80644__$2)));
}
} else {
return null;
}
...
});})(i__80625,row_idx,c__4650__auto__,size__4651__auto__,b__80626,s__80624__$2,temp__5753__auto__,split_row_contents))
,null,null));
});})(i__80625,row_idx,c__4650__auto__,size__4651__auto__,b__80626,s__80624__$2,temp__5753__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__80626),expound$printer$multirow_$_iter__80623(cljs.core.chunk_rest(s__80624__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__80626),null);
}
} else {
var row_idx = cljs.core.first(s__80624__$2);
return cljs.core.cons((function (){var iter__4652__auto__ = ((function (row_idx,s__80624__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__80623_$_iter__80666(s__80667){
return (new cljs.core.LazySeq(null,(function (){
var s__80667__$1 = s__80667;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__80667__$1);
if(temp__5753__auto____$1){
var s__80667__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__80667__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__80667__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__80669 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__80668 = (0);
while(true){
if((i__80668 < size__4651__auto__)){
var col_idx = cljs.core._nth(c__4650__auto__,i__80668);
cljs.core.chunk_append(b__80669,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__80873 = (i__80668 + (1));
i__80668 = G__80873;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__80669),expound$printer$multirow_$_iter__80623_$_iter__80666(cljs.core.chunk_rest(s__80667__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__80669),null);
}
} else {
var col_idx = cljs.core.first(s__80667__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__80623_$_iter__80666(cljs.core.rest(s__80667__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__80624__$2,temp__5753__auto__,split_row_contents))
;
return iter__4652__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__80623(cljs.core.rest(s__80624__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__80696_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__80696_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__80736 = via;
var G__80736__$1 = (((G__80736 == null))?null:cljs.core.last(G__80736));
if((G__80736__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__80736__$1);
}
})();
var keys_specs = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__80734_SHARP_){
return cljs.spec.alpha.valid_QMARK_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__80734_SHARP_);
...
}),cljs.core.tree_seq(cljs.core.coll_QMARK_,cljs.core.seq,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"clauses","clauses",1454841241),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__80735_SHARP_){
return cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__80735_SHARP_);
}),keys_specs)], 0))], 0))))));
}
});
expound.printer.key__GT_spec = (function expound$printer$key__GT_spec(keys,problems){
var seq__80738_80892 = cljs.core.seq(problems);
var chunk__80739_80893 = null;
var count__80740_80894 = (0);
var i__80741_80895 = (0);
while(true){
if((i__80741_80895 < count__80740_80894)){
var p_80896 = chunk__80739_80893.cljs$core$IIndexed$_nth$arity$2(null,i__80741_80895);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_80896) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__80897 = seq__80738_80892;
var G__80898 = chunk__80739_80893;
var G__80899 = count__80740_80894;
var G__80900 = (i__80741_80895 + (1));
seq__80738_80892 = G__80897;
chunk__80739_80893 = G__80898;
count__80740_80894 = G__80899;
i__80741_80895 = G__80900;
continue;
} else {
var temp__5753__auto___80902 = cljs.core.seq(seq__80738_80892);
if(temp__5753__auto___80902){
var seq__80738_80903__$1 = temp__5753__auto___80902;
if(cljs.core.chunked_seq_QMARK_(seq__80738_80903__$1)){
var c__4679__auto___80904 = cljs.core.chunk_first(seq__80738_80903__$1);
var G__80905 = cljs.core.chunk_rest(seq__80738_80903__$1);
var G__80906 = c__4679__auto___80904;
var G__80907 = cljs.core.count(c__4679__auto___80904);
var G__80908 = (0);
seq__80738_80892 = G__80905;
chunk__80739_80893 = G__80906;
count__80740_80894 = G__80907;
i__80741_80895 = G__80908;
continue;
} else {
var p_80909 = cljs.core.first(seq__80738_80903__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_80909) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__80911 = cljs.core.next(seq__80738_80903__$1);
var G__80912 = null;
var G__80913 = (0);
var G__80914 = (0);
seq__80738_80892 = G__80911;
chunk__80739_80893 = G__80912;
count__80740_80894 = G__80913;
i__80741_80895 = G__80914;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__4253__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__80737_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__80737_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__80761){
var vec__80762 = p__80761;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80762,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80762,(1),null);
var G__80765 = branch;
var G__80765__$1 = (((G__80765 instanceof cljs.core.Keyword))?G__80765.fqn:null);
switch (G__80765__$1) {
case "simple":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__80765__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__80769 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80769,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80769,(1),null);
var G__80772 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__80772__$1)].join('')));
...
var len__4864__auto___80918 = arguments.length;
var i__4865__auto___80920 = (0);
while(true){
if((i__4865__auto___80920 < len__4864__auto___80918)){
args__4870__auto__.push((arguments[i__4865__auto___80920]));

var G__80921 = (i__4865__auto___80920 + (1));
i__4865__auto___80920 = G__80921;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq80773){
var G__80775 = cljs.core.first(seq80773);
var seq80773__$1 = cljs.core.next(seq80773);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__80775,seq80773__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__80797_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__80797_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__80798_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__80798_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__80799){
var vec__80800 = p__80799;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80800,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80800,(1),null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__80803_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__80803_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__80813 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
var seq__80814 = cljs.core.seq(vec__80813);
var first__80815 = cljs.core.first(seq__80814);
var seq__80814__$1 = cljs.core.next(seq__80814);
var line = first__80815;
var lines = seq__80814__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__80810_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__80810_SHARP_)].join('');
}),lines)));
}));
...
while(true){
var vec__80820 = in$;
var seq__80821 = cljs.core.seq(vec__80820);
var first__80822 = cljs.core.first(seq__80821);
var seq__80821__$1 = cljs.core.next(seq__80821);
var k = first__80822;
var rst = seq__80821__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__80826 = show_valid_values_QMARK_;
var G__80827 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__80828 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__80826,G__80827,G__80828) : expound.printer.summary_form.call(null,G__80826,G__80827,G__80828));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__80930 = show_valid_values_QMARK_;
var G__80931 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__80932 = rst__$1;
show_valid_values_QMARK_ = G__80930;
form = G__80931;
in$ = G__80932;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__80829 = show_valid_values_QMARK_;
var G__80830 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__80831 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__80829,G__80830,G__80831) : expound.printer.summary_form.call(null,G__80829,G__80830,G__80831));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__80832 = show_valid_values_QMARK_;
var G__80833 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__80834 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__80832,G__80833,G__80834) : expound.printer.summary_form.call(null,G__80832,G__80833,G__80834));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__80835 = show_valid_values_QMARK_;
var G__80836 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__80837 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__80835,G__80836,G__80837) : expound.printer.summary_form.call(null,G__80835,G__80836,G__80837));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__80838 = show_valid_values_QMARK_;
var G__80839 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__80840 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__80838,G__80839,G__80840) : expound.printer.summary_form.call(null,G__80838,G__80839,G__80840));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__80841_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__80841_SHARP_)).length);
...
var map__80842 = problem;
var map__80842__$1 = cljs.core.__destructure_map(map__80842);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80842__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80842__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__80843 = opts;
var map__80843__$1 = cljs.core.__destructure_map(map__80843);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__80843__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__80847 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__80848 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__80848);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__80847);
}})();
var vec__80844 = cljs.core.re_find(regex,s);
var seq__80845 = cljs.core.seq(vec__80844);
var first__80846 = cljs.core.first(seq__80845);
var seq__80845__$1 = cljs.core.next(seq__80845);
var line = first__80846;
var first__80846__$1 = cljs.core.first(seq__80845__$1);
var seq__80845__$2 = cljs.core.next(seq__80845__$1);
var prefix = first__80846__$1;
var _more = seq__80845__$2;
