...
var G__86218 = current_node.parentNode;
var G__86219 = (sum_scroll_left + current_node.scrollLeft);
var G__86220 = (sum_scroll_top + current_node.scrollTop);
current_node = G__86218;
sum_scroll_left = G__86219;
sum_scroll_top = G__86220;
continue;
} else {
...
var vec__86068 = (cljs.core.truth_(size_only)?split_size_only:null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86068,(0),null);
var num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86068,(1),null);
var units = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86068,(2),null);
...
var len__4864__auto___86253 = arguments.length;
var i__4865__auto___86254 = (0);
while(true){
if((i__4865__auto___86254 < len__4864__auto___86253)){
args__4870__auto__.push((arguments[i__4865__auto___86254]));

var G__86255 = (i__4865__auto___86254 + (1));
i__4865__auto___86254 = G__86255;
continue;
} else {
}
break;
...
(re_frisk.ui.components.splits.h_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__86102){
var map__86103 = p__86102;
var map__86103__$1 = cljs.core.__destructure_map(map__86103);
var args = map__86103__$1;
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__86103__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86103__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86103__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86103__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__86103__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__86103__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__86103__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
var document = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__86103__$1,new cljs.core.Keyword(null,"document","document",-1329188687),document);
...
var G__86109_86257 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__86109_86257) : on_split_change.call(null,G__86109_86257));
} else {
}
...
return (function() { 
var G__86271__delegate = function (p__86140){
var map__86141 = p__86140;
var map__86141__$1 = cljs.core.__destructure_map(map__86141);
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86141__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86141__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86141__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86141__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86141__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86141__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86141__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86141__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86141__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86141__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86141__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86141__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__86271 = function (var_args){
var p__86140 = null;
if (arguments.length > 0) {
var G__86277__i = 0, G__86277__a = new Array(arguments.length -  0);
while (G__86277__i < G__86277__a.length) {G__86277__a[G__86277__i] = arguments[G__86277__i + 0]; ++G__86277__i;}
  p__86140 = new cljs.core.IndexedSeq(G__86277__a,0,null);
} 
return G__86271__delegate.call(this,p__86140);};
G__86271.cljs$lang$maxFixedArity = 0;
G__86271.cljs$lang$applyTo = (function (arglist__86278){
var p__86140 = cljs.core.seq(arglist__86278);
return G__86271__delegate(p__86140);
});
G__86271.cljs$core$IFn$_invoke$arity$variadic = G__86271__delegate;
return G__86271;
})()
;
}));
...
/** @this {Function} */
(re_frisk.ui.components.splits.h_split.cljs$lang$applyTo = (function (seq86091){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq86091));
}));
...
var args__4870__auto__ = [];
var len__4864__auto___86280 = arguments.length;
var i__4865__auto___86283 = (0);
while(true){
if((i__4865__auto___86283 < len__4864__auto___86280)){
args__4870__auto__.push((arguments[i__4865__auto___86283]));

var G__86286 = (i__4865__auto___86283 + (1));
i__4865__auto___86283 = G__86286;
continue;
} else {
}
break;
...
(re_frisk.ui.components.splits.v_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__86150){
var map__86151 = p__86150;
var map__86151__$1 = cljs.core.__destructure_map(map__86151);
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__86151__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86151__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86151__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86151__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__86151__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__86151__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__86151__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
var document = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__86151__$1,new cljs.core.Keyword(null,"document","document",-1329188687),document);
...
var stop_drag = (function (){
if(cljs.core.truth_(on_split_change)){
var G__86154_86290 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__86154_86290) : on_split_change.call(null,G__86154_86290));
} else {
}
...
return (function() { 
var G__86307__delegate = function (p__86193){
var map__86194 = p__86193;
var map__86194__$1 = cljs.core.__destructure_map(map__86194);
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var open_bottom_split_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"open-bottom-split?","open-bottom-split?",953160965));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var close_bottom_split_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"close-bottom-split?","close-bottom-split?",1606756910));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86194__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__86307 = function (var_args){
var p__86193 = null;
if (arguments.length > 0) {
var G__86312__i = 0, G__86312__a = new Array(arguments.length -  0);
while (G__86312__i < G__86312__a.length) {G__86312__a[G__86312__i] = arguments[G__86312__i + 0]; ++G__86312__i;}
  p__86193 = new cljs.core.IndexedSeq(G__86312__a,0,null);
} 
return G__86307__delegate.call(this,p__86193);};
G__86307.cljs$lang$maxFixedArity = 0;
G__86307.cljs$lang$applyTo = (function (arglist__86313){
var p__86193 = cljs.core.seq(arglist__86313);
return G__86307__delegate(p__86193);
});
G__86307.cljs$core$IFn$_invoke$arity$variadic = G__86307__delegate;
return G__86307;
})()
;
}));
...
/** @this {Function} */
(re_frisk.ui.components.splits.v_split.cljs$lang$applyTo = (function (seq86148){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq86148));
}));
