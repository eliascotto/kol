...
var G__78909 = format;
var G__78909__$1 = (((G__78909 instanceof cljs.core.Keyword))?G__78909.fqn:null);
switch (G__78909__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__78913 = cljs.core.second(format);
var G__78914 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__78913,G__78914) : ajax.easy.keyword_response_format_element.call(null,G__78913,G__78914));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__78915 = format;
var G__78915__$1 = (((G__78915 instanceof cljs.core.Keyword))?G__78915.fqn:null);
switch (G__78915__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__78918_SHARP_){
return ajax.easy.keyword_response_format_element(p1__78918_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__78925){
var map__78927 = p__78925;
var map__78927__$1 = cljs.core.__destructure_map(map__78927);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78927__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78927__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78927__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__78931){
var vec__78932 = p__78931;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78932,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78932,(1),null);
var fexpr__78935_78970 = (cljs.core.truth_(ok)?h:e);
(fexpr__78935_78970.cljs$core$IFn$_invoke$arity$1 ? fexpr__78935_78970.cljs$core$IFn$_invoke$arity$1(result) : fexpr__78935_78970.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__78936){
var map__78937 = p__78936;
var map__78937__$1 = cljs.core.__destructure_map(map__78937);
var opts = map__78937__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78937__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78937__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78937__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78937__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78937__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
