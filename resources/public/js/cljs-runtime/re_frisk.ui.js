...
return (function (){
var map__89340 = new cljs.core.Keyword(null,"opts","opts",155075701).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(re_frisk.db.tool_state));
var map__89340__$1 = cljs.core.__destructure_map(map__89340);
var ext_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89340__$1,new cljs.core.Keyword(null,"ext_height","ext_height",-46169089));
var ext_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89340__$1,new cljs.core.Keyword(null,"ext_width","ext_width",925500566));
var win = window.open("","Debugger",["width=",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__4253__auto__ = ext_width;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return (800);
}
})()),",height=",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__4253__auto__ = ext_height;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return (800);
...
var left = (function (){var or__4253__auto__ = re_frisk.utils.normalize_draggable(new cljs.core.Keyword(null,"x","x",2099068185).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(re_frisk.ui.components.drag.draggable)));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
