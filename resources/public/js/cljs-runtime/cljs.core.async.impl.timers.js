...
var i_68285 = (0);
while(true){
if((i_68285 < arr.length)){
(arr[i_68285] = null);

var G__68286 = (i_68285 + (1));
i_68285 = G__68286;
continue;
} else {
}
...
var i_68294 = (self__.level + (1));
while(true){
if((i_68294 <= (new_level + (1)))){
(update[i_68294] = self__.header);

var G__68295 = (i_68294 + (1));
i_68294 = G__68295;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_68296 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_68296[i]));
} else {
x__$2.forward.push((((i < links_68296.length))?(links_68296[i]):null));
}

if((i < links_68296.length)){
(links_68296[i] = x__$2);
} else {
links_68296.push(x__$2);
}
...
var i_68299 = (0);
while(true){
if((i_68299 <= self__.level)){
var links_68300 = (update[i_68299]).forward;
if((x__$1 === (((i_68299 < links_68300.length))?(links_68300[i_68299]):null))){
(links_68300[i_68299] = (x__$1.forward[i_68299]));

var G__68302 = (i_68299 + (1));
i_68299 = G__68302;
continue;
} else {
var G__68303 = (i_68299 + (1));
i_68299 = G__68303;
continue;
}
} else {
...
var G__68305 = nx;
var G__68306 = (level__$1 - (1));
x = G__68305;
level__$1 = G__68306;
continue;
} else {
var G__68307 = x;
var G__68308 = (level__$1 - (1));
x = G__68307;
level__$1 = G__68308;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__68310 = nx;
var G__68311 = (level__$1 - (1));
x = G__68310;
level__$1 = G__68311;
continue;
} else {
var G__68312 = x;
var G__68313 = (level__$1 - (1));
x = G__68312;
level__$1 = G__68313;
continue;
}
