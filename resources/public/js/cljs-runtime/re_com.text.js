...
var len__4864__auto___85381 = arguments.length;
var i__4865__auto___85382 = (0);
while(true){
if((i__4865__auto___85382 < len__4864__auto___85381)){
args__4870__auto__.push((arguments[i__4865__auto___85382]));

var G__85384 = (i__4865__auto___85382 + (1));
i__4865__auto___85382 = G__85384;
continue;
} else {
}
break;
...
(re_com.text.label.cljs$core$IFn$_invoke$arity$variadic = (function (p__85287){
var map__85289 = p__85287;
var map__85289__$1 = cljs.core.__destructure_map(map__85289);
var args = map__85289__$1;
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85289__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85289__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85289__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85289__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85289__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85289__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
/** @this {Function} */
(re_com.text.label.cljs$lang$applyTo = (function (seq85276){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq85276));
}));
...
var args__4870__auto__ = [];
var len__4864__auto___85392 = arguments.length;
var i__4865__auto___85394 = (0);
while(true){
if((i__4865__auto___85394 < len__4864__auto___85392)){
args__4870__auto__.push((arguments[i__4865__auto___85394]));

var G__85397 = (i__4865__auto___85394 + (1));
i__4865__auto___85394 = G__85397;
continue;
} else {
}
break;
...
(re_com.text.title.cljs$core$IFn$_invoke$arity$variadic = (function (p__85319){
var map__85320 = p__85319;
var map__85320__$1 = cljs.core.__destructure_map(map__85320);
var args = map__85320__$1;
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85320__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85320__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var underline_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85320__$1,new cljs.core.Keyword(null,"underline?","underline?",-1123247603));
var margin_top = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__85320__$1,new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"0.6em");
var margin_bottom = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__85320__$1,new cljs.core.Keyword(null,"margin-bottom","margin-bottom",388334941),"0.3em");
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85320__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85320__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85320__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
/** @this {Function} */
(re_com.text.title.cljs$lang$applyTo = (function (seq85310){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq85310));
}));
...
var args__4870__auto__ = [];
var len__4864__auto___85404 = arguments.length;
var i__4865__auto___85405 = (0);
while(true){
if((i__4865__auto___85405 < len__4864__auto___85404)){
args__4870__auto__.push((arguments[i__4865__auto___85405]));

var G__85406 = (i__4865__auto___85405 + (1));
i__4865__auto___85405 = G__85406;
continue;
} else {
}
break;
...
var vec__85346 = ((cljs.core.map_QMARK_(child1))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [child1,cljs.core.rest(children)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,children], null));
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85346,(0),null);
var children__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85346,(1),null);
...
/** @this {Function} */
(re_com.text.p.cljs$lang$applyTo = (function (seq85336){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq85336));
}));
...
var args__4870__auto__ = [];
var len__4864__auto___85413 = arguments.length;
var i__4865__auto___85414 = (0);
while(true){
if((i__4865__auto___85414 < len__4864__auto___85413)){
args__4870__auto__.push((arguments[i__4865__auto___85414]));

var G__85415 = (i__4865__auto___85414 + (1));
i__4865__auto___85414 = G__85415;
continue;
} else {
}
break;
...
var argseq__4871__auto__ = ((((0) < args__4870__auto__.length))?(new cljs.core.IndexedSeq(args__4870__auto__.slice((0)),(0),null)):null);
return re_com.text.p_span.cljs$core$IFn$_invoke$arity$variadic(argseq__4871__auto__);
});

(re_com.text.p_span.cljs$core$IFn$_invoke$arity$variadic = (function (children){
var child1 = cljs.core.first(children);
var vec__85369 = ((cljs.core.map_QMARK_(child1))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [child1,cljs.core.rest(children)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,children], null));
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85369,(0),null);
var children__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85369,(1),null);
...
/** @this {Function} */
(re_com.text.p_span.cljs$lang$applyTo = (function (seq85362){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq85362));
}));
