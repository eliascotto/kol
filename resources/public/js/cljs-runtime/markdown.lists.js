...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function markdown$lists$close_lists_$_iter__78001(s__78002){
return (new cljs.core.LazySeq(null,(function (){
var s__78002__$1 = s__78002;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__78002__$1);
if(temp__5753__auto__){
var s__78002__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__78002__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__78002__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__78004 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__78003 = (0);
while(true){
if((i__78003 < size__4651__auto__)){
var vec__78028 = cljs.core._nth(c__4650__auto__,i__78003);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78028,(0),null);
cljs.core.chunk_append(b__78004,["</li></",cljs.core.name(list_type),">"].join(''));

var G__78198 = (i__78003 + (1));
i__78003 = G__78198;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__78004),markdown$lists$close_lists_$_iter__78001(cljs.core.chunk_rest(s__78002__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__78004),null);
}
} else {
var vec__78041 = cljs.core.first(s__78002__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78041,(0),null);
return cljs.core.cons(["</li></",cljs.core.name(list_type),">"].join(''),markdown$lists$close_lists_$_iter__78001(cljs.core.rest(s__78002__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__78055_SHARP_){
return (cljs.core.second(p1__78055_SHARP_) > num_indents);
...
var vec__78098 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78098,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78098,(1),null);
...
var vec__78117 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78117,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78117,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__78141){
var map__78142 = p__78141;
var map__78142__$1 = cljs.core.__destructure_map(map__78142);
var state = map__78142__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78142__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78142__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78142__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78142__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
