...
return [(function (){var pred__76831 = cljs.core.instance_QMARK_;
var expr__76832 = reactive_val;
if(cljs.core.truth_((pred__76831.cljs$core$IFn$_invoke$arity$2 ? pred__76831.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__76832) : pred__76831.call(null,reagent.ratom.RAtom,expr__76832)))){
return "ra";
} else {
if(cljs.core.truth_((pred__76831.cljs$core$IFn$_invoke$arity$2 ? pred__76831.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__76832) : pred__76831.call(null,reagent.ratom.RCursor,expr__76832)))){
return "rc";
} else {
if(cljs.core.truth_((pred__76831.cljs$core$IFn$_invoke$arity$2 ? pred__76831.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__76832) : pred__76831.call(null,reagent.ratom.Reaction,expr__76832)))){
return "rx";
} else {
if(cljs.core.truth_((pred__76831.cljs$core$IFn$_invoke$arity$2 ? pred__76831.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__76832) : pred__76831.call(null,reagent.ratom.Track,expr__76832)))){
return "tr";
} else {
return "other";
}
