...
var self__ = this;
var ___$1 = this;
var fexpr__74163 = taoensso.sente.packers.transit.get_transit_writer_fn(self__.transit_fmt,self__.writer_opts);
return (fexpr__74163.cljs$core$IFn$_invoke$arity$1 ? fexpr__74163.cljs$core$IFn$_invoke$arity$1(x) : fexpr__74163.call(null,x));
}));

(taoensso.sente.packers.transit.TransitPacker.prototype.taoensso$sente$interfaces$IPacker$unpack$arity$2 = (function (_,s){
var self__ = this;
var ___$1 = this;
var fexpr__74164 = taoensso.sente.packers.transit.get_transit_reader_fn(self__.transit_fmt,self__.reader_opts);
return (fexpr__74164.cljs$core$IFn$_invoke$arity$1 ? fexpr__74164.cljs$core$IFn$_invoke$arity$1(s) : fexpr__74164.call(null,s));
}));
...
var e_74175 = (function (){try{if((function (x){
return cljs.core.contains_QMARK_((function (){var G__74171 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"json","json",1279968570),null], null), null);
return (taoensso.truss.impl.set_STAR_.cljs$core$IFn$_invoke$arity$1 ? taoensso.truss.impl.set_STAR_.cljs$core$IFn$_invoke$arity$1(G__74171) : taoensso.truss.impl.set_STAR_.call(null,G__74171));
})(),x);
})(transit_fmt)){
return null;
} else {
...
}catch (e74170){if((e74170 instanceof Error)){
var e_74175 = e74170;
return e_74175;
} else {
throw e74170;
...
taoensso.truss.impl._invar_violation_BANG_(true,"taoensso.sente.packers.transit",102,"([:el #{:json}] transit-fmt)",transit_fmt,e_74175,null);
}
...
}catch (e74172){if((e74172 instanceof Error)){
var e = e74172;
return e;
} else {
throw e74172;
...
}catch (e74173){if((e74173 instanceof Error)){
var e = e74173;
return e;
} else {
throw e74173;
