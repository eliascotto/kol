...
var periods__$1 = cljs.core.vec((function (){var G__79594 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__79592_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__79592_SHARP_,(0),(3));
}),G__79594);
} else {
return G__79594;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__79606){
var vec__79607 = p__79606;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79607,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79607,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__79610 = pattern;
switch (G__79610) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__79610)].join('')));
...
var G__79619 = key;
var G__79619__$1 = (((G__79619 instanceof cljs.core.Keyword))?G__79619.fqn:null);
switch (G__79619__$1) {
case "millis":
return (function (p1__79611_SHARP_){
return p1__79611_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__79612_SHARP_){
return p1__79612_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__79613_SHARP_){
return p1__79613_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__79614_SHARP_){
return p1__79614_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__79615_SHARP_){
return p1__79615_SHARP_.getHours();
});

break;
case "day":
return (function (p1__79616_SHARP_){
return p1__79616_SHARP_.getDate();
});

break;
case "month":
return (function (p1__79617_SHARP_){
return p1__79617_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__79618_SHARP_){
return p1__79618_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__79619__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__79620){
var vec__79621 = p__79620;
var seq__79622 = cljs.core.seq(vec__79621);
var first__79623 = cljs.core.first(seq__79622);
var seq__79622__$1 = cljs.core.next(seq__79622);
var key = first__79623;
var args = seq__79622__$1;
var G__79624 = key;
var G__79624__$1 = (((G__79624 instanceof cljs.core.Keyword))?G__79624.fqn:null);
switch (G__79624__$1) {
case "millis":
...
break;
case "ordinal-suffix":
var vec__79627 = (function (){var G__79631 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__79631) : syntax_list.call(null,G__79631));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79627,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__79624__$1)].join('')));
...
var d = value;
var G__79636 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__79637 = G__79636;
var seq__79638 = cljs.core.seq(vec__79637);
var first__79639 = cljs.core.first(seq__79638);
var seq__79638__$1 = cljs.core.next(seq__79638);
var unparser = first__79639;
var more = seq__79638__$1;
var s = "";
var d__$1 = d;
var G__79636__$1 = G__79636;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__79646 = G__79636__$1;
var seq__79647 = cljs.core.seq(vec__79646);
var first__79648 = cljs.core.first(seq__79647);
var seq__79647__$1 = cljs.core.next(seq__79647);
var unparser__$1 = first__79648;
var more__$1 = seq__79647__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__79649 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79649,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79649,(1),null);
var G__79683 = d__$3;
var G__79684 = more__$1;
var G__79685 = s__$3;
d__$1 = G__79683;
G__79636__$1 = G__79684;
s__$1 = G__79685;
continue;
}
break;
