...
var len__4864__auto___85432 = arguments.length;
var i__4865__auto___85433 = (0);
while(true){
if((i__4865__auto___85433 < len__4864__auto___85432)){
args__4870__auto__.push((arguments[i__4865__auto___85433]));

var G__85434 = (i__4865__auto___85433 + (1));
i__4865__auto___85433 = G__85434;
continue;
} else {
}
break;
...
(re_com.splits.h_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__85302){
var map__85304 = p__85302;
var map__85304__$1 = cljs.core.__destructure_map(map__85304);
var args = map__85304__$1;
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__85304__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85304__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85304__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85304__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__85304__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__85304__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__85304__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
...
var G__85308_85447 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__85308_85447) : on_split_change.call(null,G__85308_85447));
} else {
}
...
var _LT_html_GT__QMARK_ = (function (p1__85292_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__85292_SHARP_,document.documentElement);
});
...
return (function() { 
var G__85486__delegate = function (p__85331){
var map__85333 = p__85331;
var map__85333__$1 = cljs.core.__destructure_map(map__85333);
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85333__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85333__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85333__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85333__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85333__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85333__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85333__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85333__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85333__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85333__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85333__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85333__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__85486 = function (var_args){
var p__85331 = null;
if (arguments.length > 0) {
var G__85498__i = 0, G__85498__a = new Array(arguments.length -  0);
while (G__85498__i < G__85498__a.length) {G__85498__a[G__85498__i] = arguments[G__85498__i + 0]; ++G__85498__i;}
  p__85331 = new cljs.core.IndexedSeq(G__85498__a,0,null);
} 
return G__85486__delegate.call(this,p__85331);};
G__85486.cljs$lang$maxFixedArity = 0;
G__85486.cljs$lang$applyTo = (function (arglist__85499){
var p__85331 = cljs.core.seq(arglist__85499);
return G__85486__delegate(p__85331);
});
G__85486.cljs$core$IFn$_invoke$arity$variadic = G__85486__delegate;
return G__85486;
})()
;
}));
...
/** @this {Function} */
(re_com.splits.h_split.cljs$lang$applyTo = (function (seq85294){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq85294));
}));
...
var args__4870__auto__ = [];
var len__4864__auto___85501 = arguments.length;
var i__4865__auto___85502 = (0);
while(true){
if((i__4865__auto___85502 < len__4864__auto___85501)){
args__4870__auto__.push((arguments[i__4865__auto___85502]));

var G__85505 = (i__4865__auto___85502 + (1));
i__4865__auto___85502 = G__85505;
continue;
} else {
}
break;
...
(re_com.splits.v_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__85359){
var map__85360 = p__85359;
var map__85360__$1 = cljs.core.__destructure_map(map__85360);
var args = map__85360__$1;
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__85360__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85360__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85360__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85360__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__85360__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__85360__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__85360__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
...
var stop_drag = (function (){
if(cljs.core.truth_(on_split_change)){
var G__85367_85521 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__85367_85521) : on_split_change.call(null,G__85367_85521));
} else {
}
...
var _LT_html_GT__QMARK_ = (function (p1__85345_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__85345_SHARP_,document.documentElement);
});
var mouseout = (function (event){
if(_LT_html_GT__QMARK_(event.relatedTarget)){
return stop_drag();
...
return (function() { 
var G__85557__delegate = function (p__85398){
var map__85399 = p__85398;
var map__85399__$1 = cljs.core.__destructure_map(map__85399);
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85399__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85399__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85399__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85399__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85399__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85399__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85399__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85399__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85399__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85399__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85399__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85399__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__85557 = function (var_args){
var p__85398 = null;
if (arguments.length > 0) {
var G__85559__i = 0, G__85559__a = new Array(arguments.length -  0);
while (G__85559__i < G__85559__a.length) {G__85559__a[G__85559__i] = arguments[G__85559__i + 0]; ++G__85559__i;}
  p__85398 = new cljs.core.IndexedSeq(G__85559__a,0,null);
} 
return G__85557__delegate.call(this,p__85398);};
G__85557.cljs$lang$maxFixedArity = 0;
G__85557.cljs$lang$applyTo = (function (arglist__85560){
var p__85398 = cljs.core.seq(arglist__85560);
return G__85557__delegate(p__85398);
});
G__85557.cljs$core$IFn$_invoke$arity$variadic = G__85557__delegate;
return G__85557;
})()
;
}));
...
/** @this {Function} */
(re_com.splits.v_split.cljs$lang$applyTo = (function (seq85349){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq85349));
}));
