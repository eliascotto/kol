...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_65213 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_65213(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_65214 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_65214(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_65215 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_65215(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_65217 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_65217(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_65220 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_65220(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_65224 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_65224(reader);
}
});
...
var G__65339 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__65340 = s.append(c);
c = G__65339;
s = G__65340;
continue;
}
