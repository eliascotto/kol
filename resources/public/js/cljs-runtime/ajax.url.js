...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__77512){
var vec__77513 = p__77512;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77513,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77513,(1),null);
...
var vec_key_encode = (function (){var G__77523 = (function (){var or__4253__auto__ = vec_strategy;
...
var G__77523__$1 = (((G__77523 instanceof cljs.core.Keyword))?G__77523.fqn:null);
switch (G__77523__$1) {
case "java":
return (function (k){
return null;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__77523__$1)].join('')));
 ...
 */
ajax.url.param_to_key_value_pairs = (function ajax$url$param_to_key_value_pairs(vec_key_transform,prefix,p__77554){
var vec__77555 = p__77554;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77555,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77555,(1),null);
...
(ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__77582){
var map__77583 = p__77582;
var map__77583__$1 = cljs.core.__destructure_map(map__77583);
var vec_strategy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77583__$1,new cljs.core.Keyword(null,"vec-strategy","vec-strategy",1843221372));
