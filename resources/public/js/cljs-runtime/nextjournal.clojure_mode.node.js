...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__71406)].join('')));
...
var G__71422 = nextjournal.clojure_mode.node.type(n).prop(module$node_modules$lezer_tree$dist$tree_cjs.NodeProp.closedBy);
if((G__71422 == null)){
return null;
} else {
return (G__71422[(0)]);
...
var G__71423 = nextjournal.clojure_mode.node.type(n).prop(module$node_modules$lezer_tree$dist$tree_cjs.NodeProp.openedBy);
if((G__71423 == null)){
return null;
} else {
return (G__71423[(0)]);
...
nextjournal.clojure_mode.node.balanced_QMARK_ = (function nextjournal$clojure_mode$node$balanced_QMARK_(p__71424){
var map__71425 = p__71424;
var map__71425__$1 = (((((!((map__71425 == null))))?(((((map__71425.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71425.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__71425):map__71425);
var node = map__71425__$1;
var firstChild = (function (){var obj71427 = map__71425__$1;
var k71428 = "firstChild";
if((function (){var obj71429 = obj71427;
return (((!((obj71429 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k71428,obj71429)));
})()){
return (obj71427[k71428]);
} else {
return undefined;
}
})();
var lastChild = (function (){var obj71430 = map__71425__$1;
var k71431 = "lastChild";
if((function (){var obj71432 = obj71430;
return (((!((obj71432 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k71431,obj71432)));
})()){
return (obj71430[k71431]);
} else {
return undefined;
}
})();
...
var temp__5757__auto__ = (function (){var G__71435 = dir;
switch (G__71435) {
case (1):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__71435)].join('')));
...
return nextjournal.clojure_mode.node.children.cljs$core$IFn$_invoke$arity$3(parent,(function (){var G__71436 = dir;
switch (G__71436) {
case (1):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__71436)].join('')));
...
var G__71441 = cljs.core.compare(nextjournal.clojure_mode.node.start(to_node),nextjournal.clojure_mode.node.start(node));
switch (G__71441) {
case (0):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__71441)].join('')));

}
}
});
nextjournal.clojure_mode.node.nodes_between = (function nextjournal$clojure_mode$node$nodes_between(node,to_node){
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,cljs.core.iterate((function (p1__71442_SHARP_){
return nextjournal.clojure_mode.node.move_toward(p1__71442_SHARP_,to_node);
}),node));
});
...
var or__4253__auto__ = nextjournal.clojure_mode.node.highest(node,(function (p1__71447_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(from,nextjournal.clojure_mode.node.start(p1__71447_SHARP_));
}));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
var vec__71451 = cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [from,to], null));
var from__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71451,(0),null);
var to__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71451,(1),null);
...
var vec__71454 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__71457,node_between){
var vec__71458 = p__71457;
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71458,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71458,(1),null);
...
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [from__$2,to__$2], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__71448_SHARP_){
var G__71461 = p1__71448_SHARP_;
if(nextjournal.clojure_mode.node.edge_QMARK_(p1__71448_SHARP_)){
return nextjournal.clojure_mode.node.up(G__71461);
} else {
return G__71461;
}
}),nextjournal.clojure_mode.node.nodes_between(from_node,to_node)));
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71454,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71454,(1),null);
 ...
 */
nextjournal.clojure_mode.node.inner_span = (function nextjournal$clojure_mode$node$inner_span(p__71462){
var map__71463 = p__71462;
var map__71463__$1 = (((((!((map__71463 == null))))?(((((map__71463.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71463.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__71463):map__71463);
var node = map__71463__$1;
var firstChild = (function (){var obj71465 = map__71463__$1;
var k71466 = "firstChild";
if((function (){var obj71467 = obj71465;
return (((!((obj71467 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k71466,obj71467)));
})()){
return (obj71465[k71466]);
} else {
return undefined;
}
})();
var lastChild = (function (){var obj71468 = map__71463__$1;
var k71469 = "lastChild";
if((function (){var obj71470 = obj71468;
return (((!((obj71470 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k71469,obj71470)));
})()){
return (obj71468[k71469]);
} else {
return undefined;
}
})();
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__71472 = nextjournal.clojure_mode.node.prefix(node);
if((G__71472 == null)){
return null;
} else {
return nextjournal.clojure_mode.node.string.cljs$core$IFn$_invoke$arity$2(state,G__71472);
}
...
return nextjournal.clojure_mode.node.up(G__71473);
} else {
return G__71473;
}
});
...
var G__71475 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(-1));
if((G__71475 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__71475,(function (p1__71474_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pos,nextjournal.clojure_mode.node.end(p1__71474_SHARP_));
}));
}
});
/**
...
var G__71477 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(1));
if((G__71477 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__71477,(function (p1__71476_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pos,nextjournal.clojure_mode.node.start(p1__71476_SHARP_));
}));
}
});
nextjournal.clojure_mode.node.nearest_touching = (function nextjournal$clojure_mode$node$nearest_touching(state,pos,dir){
var L = (function (){var G__71480 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(-1));
if((G__71480 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__71480,(function (p__71481){
var map__71482 = p__71481;
...
var to = (function (){var obj71484 = map__71482__$1;
var k71485 = "to";
if((function (){var obj71486 = obj71484;
return (((!((obj71486 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k71485,obj71486)));
})()){
return (obj71484[k71485]);
} else {
return undefined;
}
})();
...
var R = (function (){var G__71487 = nextjournal.clojure_mode.node.tree.cljs$core$IFn$_invoke$arity$3(state,pos,(1));
if((G__71487 == null)){
return null;
} else {
return nextjournal.clojure_mode.util.guard(G__71487,(function (p__71488){
var map__71489 = p__71488;
...
var from = (function (){var obj71491 = map__71489__$1;
var k71492 = "from";
if((function (){var obj71493 = obj71491;
return (((!((obj71493 == null)))) && (applied_science.js_interop.impl.in_QMARK__STAR_(k71492,obj71493)));
})()){
return (obj71491[k71492]);
} else {
return undefined;
}
})();
...
switch (G__71494) {
case (1):
var or__4253__auto__ = nextjournal.clojure_mode.util.guard(R,cljs.core.every_pred.cljs$core$IFn$_invoke$arity$2(cljs.core.some_QMARK_,(function (p1__71478_SHARP_){
return ((nextjournal.clojure_mode.node.same_edge_QMARK_(p1__71478_SHARP_)) || ((!(nextjournal.clojure_mode.node.right_edge_QMARK_(p1__71478_SHARP_)))));
})));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
break;
case (-1):
var or__4253__auto__ = nextjournal.clojure_mode.util.guard(L,cljs.core.every_pred.cljs$core$IFn$_invoke$arity$2(cljs.core.some_QMARK_,(function (p1__71479_SHARP_){
return ((nextjournal.clojure_mode.node.same_edge_QMARK_(p1__71479_SHARP_)) || ((!(nextjournal.clojure_mode.node.left_edge_QMARK_(p1__71479_SHARP_)))));
})));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__71494)].join('')));
