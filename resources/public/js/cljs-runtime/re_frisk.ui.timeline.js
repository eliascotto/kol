...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(tool_state,cljs.core.update,new cljs.core.Keyword(null,"timeline-zoom","timeline-zoom",-2049020154),(function (p1__86063_SHARP_){
if(cljs.core.truth_(inc_QMARK_)){
return (p1__86063_SHARP_ + (((curr < 0.1))?0.01:curr));
} else {
return (p1__86063_SHARP_ - (((curr <= 0.1))?0.01:(curr / (2))));
}
}));
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__86081_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__86081_SHARP_,new cljs.core.Keyword(null,"selected?","selected?",-742502788),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(indx),new cljs.core.Keyword(null,"indx","indx",1571035590).cljs$core$IFn$_invoke$arity$1(p1__86081_SHARP_)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"width","width",-384071477),(function (){var width = (new cljs.core.Keyword(null,"duration","duration",1444101068).cljs$core$IFn$_invoke$arity$1(p1__86081_SHARP_) * cljs.core.deref(mult));
return ((((width < (2)))?(2):width) | (0));
})(),new cljs.core.Keyword(null,"color","color",1011675173),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(indx),new cljs.core.Keyword(null,"indx","indx",1571035590).cljs$core$IFn$_invoke$arity$1(p1__86081_SHARP_)))?"#df691a":((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(p1__86081_SHARP_),new cljs.core.Keyword(null,"event","event",301435442)))?new cljs.core.Keyword(null,"blue","blue",-622100620):"#219653"))], 0));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__86097),re_frisk$ui$timeline$timeline_$_iter__86094(cljs.core.chunk_rest(s__86095__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__86097),null);
}
} else {
var x = cljs.core.first(s__86095__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"width","width",-384071477),(devi * mult__$1),new cljs.core.Keyword(null,"min-width","min-width",1926193728),(devi * mult__$1),new cljs.core.Keyword(null,"height","height",1025178622),(90),new cljs.core.Keyword(null,"border-left-width","border-left-width",2037218085),(1),new cljs.core.Keyword(null,"border-left-color","border-left-color",-1166146583),new cljs.core.Keyword(null,"gray","gray",1013268388),new cljs.core.Keyword(null,"border-left-style","border-left-style",65166675),new cljs.core.Keyword(null,"solid","solid",-2023773691),new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"gray","gray",1013268388),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(10)], null)], null),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(((x * devi) | (0)))," ms"].join('')], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["timelime-time-item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x)].join('')], null)),re_frisk$ui$timeline$timeline_$_iter__86094(cljs.core.rest(s__86095__$2)));
}
} else {
return null;
}
...
})(),(function (){var iter__4652__auto__ = (function re_frisk$ui$timeline$timeline_$_iter__86110(s__86111){
return (new cljs.core.LazySeq(null,(function (){
var s__86111__$1 = s__86111;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__86111__$1);
if(temp__5753__auto__){
var s__86111__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__86111__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__86111__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__86113 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__86112 = (0);
while(true){
if((i__86112 < size__4651__auto__)){
var map__86117 = cljs.core._nth(c__4650__auto__,i__86112);
var map__86117__$1 = cljs.core.__destructure_map(map__86117);
var item = map__86117__$1;
var indx__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86117__$1,new cljs.core.Keyword(null,"indx","indx",1571035590));
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86117__$1,new cljs.core.Keyword(null,"color","color",1011675173));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86117__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var position = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86117__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
cljs.core.chunk_append(b__86113,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),["timeline-event-item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(indx__$1)].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__86112,map__86117,map__86117__$1,item,indx__$1,color,width,position,c__4650__auto__,size__4651__auto__,b__86113,s__86111__$2,temp__5753__auto__,mult__$1,devi,events,all_time,indx,mult,selected){
...
});})(i__86112,map__86117,map__86117__$1,item,indx__$1,color,width,position,c__4650__auto__,size__4651__auto__,b__86113,s__86111__$2,temp__5753__auto__,mult__$1,devi,events,all_time,indx,mult,selected))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__86113),re_frisk$ui$timeline$timeline_$_iter__86110(cljs.core.chunk_rest(s__86111__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__86113),null);
}
} else {
var map__86123 = cljs.core.first(s__86111__$2);
var map__86123__$1 = cljs.core.__destructure_map(map__86123);
var item = map__86123__$1;
var indx__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86123__$1,new cljs.core.Keyword(null,"indx","indx",1571035590));
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86123__$1,new cljs.core.Keyword(null,"color","color",1011675173));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86123__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var position = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86123__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),["timeline-event-item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(indx__$1)].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__86123,map__86123__$1,item,indx__$1,color,width,position,s__86111__$2,temp__5753__auto__,mult__$1,devi,events,all_time,indx,mult,selected){
return (function (event){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(tool_state,cljs.core.assoc,new cljs.core.Keyword(null,"selected-event","selected-event",898030638),item);
...
return event.preventDefault();
});})(map__86123,map__86123__$1,item,indx__$1,color,width,position,s__86111__$2,temp__5753__auto__,mult__$1,devi,events,all_time,indx,mult,selected))
,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"left","left",-399115937),((position * mult__$1) | (0)),new cljs.core.Keyword(null,"position","position",-2011731912),new cljs.core.Keyword(null,"absolute","absolute",1655386478),new cljs.core.Keyword(null,"width","width",-384071477),width,new cljs.core.Keyword(null,"min-width","min-width",1926193728),width,new cljs.core.Keyword(null,"top","top",-1856271961),(20),new cljs.core.Keyword(null,"height","height",1025178622),(70),new cljs.core.Keyword(null,"background-color","background-color",570434026),color,new cljs.core.Keyword(null,"opacity","opacity",397153780),0.5], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["timeline-event-item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(indx__$1)].join('')], null)),re_frisk$ui$timeline$timeline_$_iter__86110(cljs.core.rest(s__86111__$2)));
}
} else {
return null;
}
