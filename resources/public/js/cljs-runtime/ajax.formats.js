...
var G__78685 = request;
var G__78686 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__78685,G__78686) : ajax.formats.get_format.call(null,G__78685,G__78686));
} else {
...
return cljs.core.some((function (p1__78705_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__78705_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__78711){
var map__78712 = p__78711;
var map__78712__$1 = cljs.core.__destructure_map(map__78712);
var request = map__78712__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78712__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__78725 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__78725.cljs$core$IFn$_invoke$arity$1 ? fexpr__78725.cljs$core$IFn$_invoke$arity$1(response) : fexpr__78725.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__78734){
var map__78735 = p__78734;
var map__78735__$1 = cljs.core.__destructure_map(map__78735);
var request = map__78735__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78735__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__78730_SHARP_){
return ajax.formats.get_accept_entries(request,p1__78730_SHARP_);
