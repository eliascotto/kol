...
var len__4864__auto___77842 = arguments.length;
var i__4865__auto___77843 = (0);
while(true){
if((i__4865__auto___77843 < len__4864__auto___77842)){
args__4870__auto__.push((arguments[i__4865__auto___77843]));

var G__77848 = (i__4865__auto___77843 + (1));
i__4865__auto___77843 = G__77848;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown.common.freeze_string.cljs$lang$applyTo = (function (seq77599){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq77599));
}));
...
var G__77849 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__5751__auto__){
return (function (s,r){
return clojure.string.replace(s,cljs.core.re_pattern(r),((function (text,state,matches,temp__5751__auto__){
return (function (p1__77610_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__77610_SHARP_,p1__77610_SHARP_);
});})(text,state,matches,temp__5751__auto__))
);
});})(text,state,matches,temp__5751__auto__))
,text,matches);
var G__77850 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5751__auto__){
return (function (p1__77611_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__77611_SHARP_,matches);
});})(text,state,matches,temp__5751__auto__))
);
text = G__77849;
state = G__77850;
...
var vec__77740 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__77747 = (function (){var G__77750 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__77751 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__77750,G__77751) : transformer.call(null,G__77750,G__77751));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77747,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77747,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77740,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77740,(1),null);
var G__77866 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__77867 = cljs.core.PersistentVector.EMPTY;
var G__77868 = cljs.core.rest(tokens);
var G__77869 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__77866;
buf = G__77867;
tokens = G__77868;
cur_state = G__77869;
...
var G__77874 = out;
var G__77875 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__77876 = cljs.core.rest(tokens);
var G__77877 = cur_state;
out = G__77874;
buf = G__77875;
tokens = G__77876;
cur_state = G__77877;
...
var G__77883 = out;
var G__77884 = buf;
var G__77885 = cljs.core.rest(tokens);
var G__77886 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__77883;
buf = G__77884;
tokens = G__77885;
cur_state = G__77886;
...
var G__77888 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__77889 = buf;
var G__77890 = cljs.core.rest(tokens);
var G__77891 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911),markdown.common.open_html_tags(new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911).cljs$core$IFn$_invoke$arity$1(cur_state),cljs.core.first(tokens)));
out = G__77888;
buf = G__77889;
tokens = G__77890;
cur_state = G__77891;
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__77800_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__77800_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__77801_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__77801_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__77801_SHARP_)));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
